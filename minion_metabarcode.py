...
snakemake.snakemake("/home/shared_docs/pipelines/minion_metabarcode/Snakefile", conda_prefix="/home/shared_docs/pipeline_envs", cores=int(usr_cores), use_conda=True, keepgoing=True, resources={"load":1}, config={"minlength":usr_minlength})
