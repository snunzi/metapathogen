...
#sys.argv = ['script.py', 'barcode07_blast.out', 'barcode07_read_number.txt', 'barcode07_consensus.fasta', 'barcode07', 'output.csv', 'output_filtered.csv', 'test']
...
summary_out = summary_out[['Barcode', 'Cluster_Name', 'Ref_Sequence', 'pident', 'Alignment_Length', 'Acc_Length', 'mismatch', 'gapopen', 'evalue', 'bitscore', '%_Ref_Cov', 'Sequence']]
